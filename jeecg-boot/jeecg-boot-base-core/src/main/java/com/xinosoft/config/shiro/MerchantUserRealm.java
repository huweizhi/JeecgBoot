...
//	@Lazy
//    @Autowired
//    @Qualifier("merchantUserServiceImpl")
...
//        }
        ...
        LoginUser loginUser = TokenUtils.getLoginUser(userType, username, null, redisUtil);
...
//        return false;
        ...
        return jwtTokenRefresh(token, 0, userName, passWord);
